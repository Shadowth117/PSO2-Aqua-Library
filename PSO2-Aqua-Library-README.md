...
# Building 
Intended for at least .NET 9 and x64 systems, but should build fine with higher .NET versions easy enough. 

# AquaModelLibrary.Core/Native
