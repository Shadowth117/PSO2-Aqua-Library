namespace AquaModelLibrary.Data.PSO2.Constants
{
    public class EffectFilenames
    {
        ...
        public static List<string> playerNGSEffects = new List<string>()
        {
            ...
            "actor/effect/effect_cold_damage.ice",
            ...
            "actor/effect/effect_object_arsenalmodule.ice",
            ...
            "actor/effect/effect_pot_atkkeep.ice",
            "actor/effect/effect_pot_bombfield.ice",
            "actor/effect/effect_pot_chaseattack.ice",
            "actor/effect/effect_pot_cochallenge.ice",
            "actor/effect/effect_pot_countpow.ice",
            "actor/effect/effect_pot_criticalbuff.ice",
            "actor/effect/effect_pot_dmgbarrier.ice",
            "actor/effect/effect_pot_eleppbonus.ice",
            "actor/effect/effect_pot_esccritical.ice",
            "actor/effect/effect_pot_escppconv.ice",
            "actor/effect/effect_pot_fieldbuff.ice",
            "actor/effect/effect_pot_killingbarrier.ice",
            "actor/effect/effect_pot_lifeguts.ice",
            "actor/effect/effect_pot_nodamagebuff.ice",
            "actor/effect/effect_pot_overtime.ice",
            "actor/effect/effect_pot_ppbonus.ice",
            "actor/effect/effect_pot_ppbonus2.ice",
            "actor/effect/effect_pot_ppboost.ice",
            "actor/effect/effect_pot_returnbarrier.ice",
            "actor/effect/effect_pot_stackheal.ice",
            "actor/effect/effect_pot_stepupbonus.ice",
            "actor/effect/effect_pot_superarmor.ice",
            "actor/effect/effect_rod.ice",
            "actor/effect/effect_sum.ice",
            "actor/effect/effect_swd.ice",
            "actor/effect/effect_tec.ice",
            "actor/effect/effect_thlys.ice",
            "actor/effect/effect_throw_bomb.ice",
            "actor/effect/effect_throw_decoy.ice",
            "actor/effect/effect_throw_fang.ice",
            "actor/effect/effect_throw_god3_bomb.ice",
            "actor/effect/effect_throw_hum_1ng_spike.ice",
            "actor/effect/effect_throw_ice.ice",
            "actor/effect/effect_throw_movement.ice",
            "actor/effect/effect_throw_plaiter_ball.ice",
            "actor/effect/effect_throw_pursuer.ice",
            "actor/effect/effect_throw_volcanic.ice",
            "actor/effect/effect_throw_zrf_bomb.ice",
            "actor/effect/effect_throw_zrf_fang.ice",
            "actor/effect/effect_throw_zrf_pillar.ice",
            "actor/effect/effect_throw_zrf_raid_bomb.ice",
            "actor/effect/effect_throw_zrf_raid_fang.ice",
            "actor/effect/effect_throw_zrf_raid_pillar.ice",
