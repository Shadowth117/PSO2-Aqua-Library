...
namespace AquaModelLibrary.Data.BillyHatcher
{
	public class DemoStageDef
	{
		...
		public DemoStageDef(string filePath)
		{
		...
		public DemoStageDef(BufferedStreamReaderBE<MemoryStream> sr)
		{
			Read(sr);
		}
		...
		public byte[] GetBytes()
		{
			...
			for (int i = 0; i < defs.Count; i++)
			{
				...
				for(int j = 0; j < commonDataList.Count; j++)
				{
					...
					if(cmn.effect == defCom.effect && cmn.particle == defCom.particle && cmn.SEBank4 == defCom.SEBank4 && cmn.SEBank6 == defCom.SEBank6 && cmn.SEBank7 == defCom.SEBank7)
					{
						match = j;
						break;
					}
