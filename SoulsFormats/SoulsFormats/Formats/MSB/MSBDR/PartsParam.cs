    ...
    public partial class MSBDR
    {
        ...
        public abstract class Part : Entry, IMsbPart
        {
            ...
            internal override void Write(BinaryWriterEx bw, int id)
            {
                ...
                bw.FillInt64("NameOffset", (int)(bw.Position - start));
                bw.WriteShiftJIS(MSB.ReambiguateName(Name), true);

                bw.FillInt64("SibOffset", (int)(bw.Position - start));
                bw.WriteShiftJIS(SibPath, true);
                bw.PadFF(4);
                if (bw.Position - stringsStart < 0x10)
                    bw.WritePattern((int)(0x10 - (bw.Position - stringsStart)), 0x00);

                bw.FillInt64("EntityDataOffset", (int)(bw.Position - start));
                WriteEntityData(bw);

                bw.FillInt64("TypeDataOffset", (int)(bw.Position - start));
                WriteTypeData(bw);
            }
            ...
            internal virtual void GetNames(MSBDR msb, Entries entries)
            {
                ModelName = MSB.FindName(entries.Models, ModelIndex);
            }

            internal virtual void GetIndices(MSBDR msb, Entries entries)
            {
